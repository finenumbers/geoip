...
Нет для базового деплоя (CLI или Portainer). Опционально: `POSTGRES_PASSWORD`, `CONFIG_MASTER_KEY` — в `.env` на хосте или в environment variables stack в Portainer.
