...
export const ui = {
  ...
  dashboard: {
    ...
    lookupLatency: 'Lookup p95',
    tableQueryLatency: 'Table query p95',
    tableQueryByMode: 'Browse queries (mode × filters)',
    tableQueryModeKeyset: 'keyset',
    tableQueryModeOffset: 'offset',
    tableQueryFiltersNone: 'без фильтров',
    tableQueryFiltersActive: 'с фильтрами',
    colId: 'ID',
    colDate: 'Дата',
    colStatus: 'Статус',
    colTrigger: 'Источник',
